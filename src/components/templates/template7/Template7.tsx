...
import {
  ...
  availableFontsCoBa,
  availableValuesTemplate7 as defaultValuesCoBa,
} from "../../../config";
...
import WidgetImage2 from "../../../assets/images/templates/template7/img2.png";
import WidgetImage3 from "../../../assets/images/templates/template7/img3.png";
import WidgetImage4 from "../../../assets/images/templates/template7/img4.png";
import WidgetImage5 from "../../../assets/images/templates/template7/img5.png";
import WidgetImage6 from "../../../assets/images/templates/template7/img6.png";
import WidgetImage7 from "../../../assets/images/templates/template7/img7.png";
import WidgetImage8 from "../../../assets/images/templates/template7/img8.png";
import WidgetImage9 from "../../../assets/images/templates/template7/img9.png";
...
const Template7: React.FC<TemplateProps> = (props) => {
  ...
  const fetchDefaultData = useCallback(async () => {
              try {
              setLoading(true);
              const res = await axios.get(`${API_BASE_URL}/api/admin/documents/7`);
  ...
  useEffect(() => {
    const fetchHiddenComponents = async () => {
      try {
        const response = await axios.get(
          `${API_BASE_URL}/api/admin/hidentemplates/7`
        );
  ...
  return (
    <section className="relative w-full h-full overflow-hidden font-meowScript">
      {!isDisabled && (
        <div className="fixed z-50  w-full bg-white">
          ...
          <div className="w-full flex items-center justify-between px-4 pb-1 max-w-9xl mx-auto gap-5 pt-2 overflow-auto md:overflow-visible">
            {/* Left Section */}
            <ColorSelect
              colorSets={availableColorsTemplate7}
      ...
      <section className="relative bg-white font-meowScript overflow-y-auto">
