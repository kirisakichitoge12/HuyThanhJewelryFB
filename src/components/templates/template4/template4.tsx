...
import {
  ...
  availableFontsCoBa,
  availableValuesTemplate4 as defaultValuesCoBa,
} from "../../../config";
...
import WidgetImage1 from "../../../assets/images/templates/template4/widget (2).png";
import WidgetImage2 from "../../../assets/images/templates/template4/widget (3).png";
import WidgetImage3 from "../../../assets/images/templates/template4/widget (4).png";
import WidgetImage4 from "../../../assets/images/templates/template4/widget (5).png";
import WidgetImage5 from "../../../assets/images/templates/template4/widget (6).png";
import WidgetImage6 from "../../../assets/images/templates/template4/widget (7).png";
import WidgetImage7 from "../../../assets/images/templates/template4/widget (8).png";
import WidgetImage8 from "../../../assets/images/templates/template4/widget (9).png";
...
const Template4: React.FC<TemplateProps> = (props) => {
    ...
    const idTemplate = useMemo(() => {
      ...
      return null; // hoặc giá trị mặc định
        ...
        const fetchDefaultData = useCallback(async () => {
                try {
                setLoading(true);
                const res = await axios.get(`${API_BASE_URL}/api/admin/documents/5`);
   ...
   // const hiddenComponentTypes = ['MessageSection']; // từ DB
          ...
          useEffect(() => {
            const fetchHiddenComponents = async () => {
              try {
                const response = await axios.get(`${API_BASE_URL}/api/admin/hidentemplates/5`);
      ...
      {!isDisabled && (
        <div className="fixed z-50  w-full bg-white">
          ...
          <div className="w-full flex items-center justify-between px-4 pb-1 max-w-9xl mx-auto gap-5 pt-2 overflow-auto md:overflow-visible">
            {/* Left Section */}
            <ColorSelect
              colorSets={availableColorsTemplate4}
