...
import { availableColorsCodien, availableFontsCoBa, availableValuesTemplate3 as defaultValuesCoBa } from '../../../config';
...
import WidgetImage1 from '../../../assets/images/templates/codien/widget (2).png';
import WidgetImage2 from '../../../assets/images/templates/codien/widget (3).png';
import WidgetImage3 from '../../../assets/images/templates/codien/widget (4).png';
import WidgetImage4 from '../../../assets/images/templates/codien/widget (5).png';
import WidgetImage5 from '../../../assets/images/templates/codien/widget (6).png';
import WidgetImage6 from '../../../assets/images/templates/codien/widget (7).png';
import WidgetImage7 from '../../../assets/images/templates/codien/widget (8).png';
import WidgetImage8 from '../../../assets/images/templates/codien/widget (9).png';
...
const Codien: React.FC<TemplateProps> = (props) => {
    const { id, userId, themeId } = useParams();
    const context = useContext(UserContext); 
    const { user } = context; 
    const { onChooseMusic } = useMusicModal();
    ...
    const { onOpen, track } = useMusicModal();  
    ...
    const handleSectionChange = (
        ...
        newValue: string | File | InvitationProps| CustomFile[] | MessageProps[] | TimelineProps,
...
//         setIsDisabled(isDisabled);
 ...
 useEffect(() => {
  ...
  fetchData();
}, [themeId, userId, resolvedUserId, resolvedThemeId, user, id]); // Bao gồm fetchDefaultData trong dependencies
    useEffect(() => {
    ...
    // const hiddenComponentTypes = ['MessageSection']; // từ DB
        ...
        useEffect(() => {
          const fetchHiddenComponents = async () => {
            try {
              const response = await axios.get(`${API_BASE_URL}/api/admin/hidentemplates/4`);
    ...
    return (
        ...
        <div className='fixed z-50  w-full bg-white'>
            ...
            <div className="w-full flex items-center justify-between px-4 pb-1 max-w-9xl mx-auto gap-5 pt-2 overflow-auto md:overflow-visible">
                {/* Left Section */} 
                <ColorSelect
                    colorSets={availableColorsCodien}
                        ...
                        return (
                            ...
                            >
                                ...
                                <Component
                                    ...
                                    disabled={isDisabled}
                                    style={selectedStyle}
                                    onSectionChange={(name: string, newValue: string | File | InvitationProps | CustomFile[] | MessageProps[] | TimelineProps, subField?: string, i?: number) =>
