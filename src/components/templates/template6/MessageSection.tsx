...
import FrameMessage1 from "../../../assets/images/templates/template6/message/bg1.png";
import FrameMessage2 from "../../../assets/images/templates/template6/message/bg2.png";
import FrameMessage3 from "../../../assets/images/templates/template6/message/bg3.png";
import DecoLeft1 from "../../../assets/images/templates/template6/message/decoLeft1.png";
import DecoLeft2 from "../../../assets/images/templates/template6/message/decoLeft2.png";
import DecoLeft3 from "../../../assets/images/templates/template6/message/decoLeft3.png";
import DecoRight1 from "../../../assets/images/templates/template6/message/decoRight1.png";
import DecoRight2 from "../../../assets/images/templates/template6/message/decoRight2.png";
import DecoRight3 from "../../../assets/images/templates/template6/message/decoRight3.png";
import Each from "../../../layouts/Each";
import { availableColors, availableColorsTemplate6 } from "../../../config";
...
const MessageSection: React.FC<MessageSectionProps> = ({
  ...
  return (
    <section id="template6-message-id" className="relative bg-white" >
      <section className="z-10 relative max-w-[1443px] mx-auto font-CormorantUnicase overflow-hidden">
        <img
          src={decoLefts[style]}
          className="md:block hidden absolute left-0 top-[382px] md:w-fit md:h-fit w-[131px] h-[184px]"
        />
        <img
          src={decoRights[style]}
          className="md:block hidden absolute right-0 top-[224px] md:w-fit md:h-fit w-[131px] h-[184px]"
        />
        <img
          src={frames[style]}
          className="absolute top-[16%] md:top-[20%] left-0 -z-10 w-[400px] md:w-full h-[420px] object-fill opacity-80"
        />
        <div className="px-[15px] py-[50px] md:py-[130px] md:px-[441px] grid text-center items-center w-full h-full">
          <h1
            className="text-title-coba-mobile md:text-[48px] tracking-wide uppercase"
            style={{ color: availableColorsTemplate6[style][0], fontFamily: titleFont }}
          >
            Sổ lưu bút
          </h1>
          <div className="relative font-svn-sans z-10 mt-[58px] space-y-6">
            <input
              name="name"
              value={formData.name}
            ...
            <button
              className="font-phudu text-[#DDCCB6] text-base w-[250px] py-4"
